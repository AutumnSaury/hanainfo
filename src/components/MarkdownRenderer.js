import { marked } from 'https://unpkg.com/marked@11.0.0/lib/marked.esm.js'
...
customElements.define('markdown-renderer', class extends HTMLElement {
  ...
  constructor () {
    ...
    this.#styleNode = this.shadowRoot.appendChild(document.createElement('style'))
    ...
    `
    this.#markdownNode = this.shadowRoot.appendChild(document.createElement('div'))
    this.#markdownNode.classList.add('markdown-body')
  }
  ...
  attributeChangedCallback (name, oldValue, newValue) {
    switch (name) {
      case 'value':
        this.#markdownNode.innerHTML = marked.parse(newValue)
        break
      default:
        break
    }
